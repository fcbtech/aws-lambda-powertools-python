...
def compare_modulo_range(context_value: int, condition_value: Dict) -> bool:
    ...
    """
    base = condition_value.get(ModuloRangeValues.BASE.value)
    start = condition_value.get(ModuloRangeValues.START.value)
    end = condition_value.get(ModuloRangeValues.END.value)
